...
parser.add_argument("--data_config_path", type=str, default="config/person.data", help="path to data config file")
parser.add_argument("--weights_path", type=str, default="checkpoints/29.weights", help="path to weights file")
parser.add_argument("--class_path", type=str, default="data/person/person.names", help="path to class label file")
